...
public class CartController {
    ...
    public static void addToCart() throws SQLException {
        ...
        if (article.id == 0) {
            ...
            System.out.println("* to see all articles : art all");
        } else {
            System.out.print("quantite : ");
            int quantite = scanner.nextInt();
            if (article.quantite < quantite) {
                System.out.println("* il rest rest que "+ article.quantite +" unit de cet article");
            } else {
    ...
    public static void getCash() throws SQLException {
        if (orders.size() > 0) {
            ...
            if (cash >= totalPrice(orders)) {
                ...
                System.out.println("argent non valid !!");
            }
            
        }else {
            System.out.println("their are no orders yet !!");
        }
    }
